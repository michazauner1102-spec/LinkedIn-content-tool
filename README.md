...
| **Virale Posts** | Bibliothek mit 20 Beispiel-Posts (fiktive Autoren, echte Muster) inkl. „Warum es funktioniert“, Filter nach Nische/Typ, „Als Vorlage nutzen“; eigenes **Swipe-File** mit automatischer Struktur-Analyse |
...
| **Grafik-Galerie** | 12 häufig genutzte LinkedIn-Grafiken (Zitat, Statistik, Checkliste, Mythos/Fakt, Vorher/Nachher, Framework, Hot Take, Post-Screenshot, Do/Don’t, Carousel-Cover, Timeline, Frage), 6 Farbwelten, 3 Formate, PNG-Download; **Carousel-Builder** mit PDF-Export für LinkedIn-Dokumente |
